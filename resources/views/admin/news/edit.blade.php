			...
			<div class="box-content form-horizontal">
				<fieldset>
					...
					<div class="control-group">
						...
						<div>
							<div>
								<input value="{!! old('description'), isset($news['description'])?$news['description']:null !!}" name="description" placeholder="Description ..." type="text" id="fname" onKeyDown="CountLeft(this.form.fname, this.form.left,150);" onKeyUp="CountLeft(this.form.fname,this.form.left,150);" class="span12 typeahead">
					...
					<div class="control-group">
						...
						<div>
							<div>
							  <input value="{!! old('keywords'), isset($news['key'])?$news['key']:null !!}" name='keywords' type="text" placeholder="keywords ..." class="span12">
							</div>
						</div>
					</div>
