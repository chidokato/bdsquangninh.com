		...
		<div class="box span6">
			...
			<div class="box-content ">
				<fieldset>
					...
					<div class="control-group">
						<label >Description ( <small>Còn lại <input readonly type="text" name="left" size=3 maxlength=3 value="150" style='color: red; width: 23px; background: none; border: none; padding: 0px; margin-bottom: 1px;' > ký tự</small> )</label>
						<div>
							<div>
								<input name="description" placeholder="Description ..." type="text" id="fname" onKeyDown="CountLeft(this.form.fname, this.form.left,150);" onKeyUp="CountLeft(this.form.fname,this.form.left,150);" class="span12 typeahead">
			...
			<div class="box-content">
				...
				<div id="myTabContent" class="tab-content">
					...
					<div class="tab-pane" id="7">
						<textarea class="span12 ckeditor" name="box"></textarea>
					</div>
