...
@endsection
@section('url')
{{asset('')}}{{$singleproduct->category->slug}}/{{$singleproduct->slug}}/{{$singleproduct->id}}.html
@endsection
@section('img')
http://bdsquangninh.com{{$singleproduct->img}}
@endsection
	...
	<div id="product-page" class="page-body">
		<div class="breadcrumb">
			<div class="uk-container uk-container-center">
				<ul class="uk-breadcrumb">
					...
					<li><a href="{{$singleproduct->category->slug}}" title="Trang chủ">{{$singleproduct->category->name}}</a></li>
					<li class="uk-active"><a href="{{$singleproduct->category->slug}}/{{$singleproduct->slug}}/{{$singleproduct->id}}.html" title="Nội thất phòng bếp">{{$singleproduct->name}}</a></li>
				</ul>
			</div>
		</div><!-- .breadcrumb -->
		<div class="uk-container uk-container-center">
		...
		<section data-uk-sticky="{top: 0}">
			<nav class="product-nav">
				<ul>
                    ...
                    <li>
                        <a href="{{$singleproduct->category->slug}}/{{$singleproduct->slug}}/{{$singleproduct->id}}.html#dang-ky">Đăng ký</a>
                    </li>
                    <div class='clr'></div>
				</ul>
			</nav><!-- .main-nav -->		
		...
		<div class="uk-grid lib-grid-20">
			<div class="uk-width-large-3-4">
				<section class="prd-detail">
					<section class="panel-body">
						@if($singleproduct->box)
						<div class="prd-content box">
							<ul id="tabContent" class="uk-switcher tab-content">
								<li aria-hidden="false" class="uk-active" style='border: none;'>
									<h3>Những ưu đãi đặc biệt cho khách hàng</h3>
						...
						<div class="prd-content" id='vi-tri'>
							<ul class="uk-list uk-clearfix nav-tabs" data-uk-switcher="{connect:'#tabContent'}">
								<li class="uk-active" aria-expanded="true">{{$singleproduct->heading1}}</li>
							</ul>
							<ul id="tabContent" class="uk-switcher tab-content">
								<li aria-hidden="false" class="uk-active">
									<article class="article detail-content">
						...
						<div class="prd-content" id='tien-ich'>
							<ul class="uk-list uk-clearfix nav-tabs" data-uk-switcher="{connect:'#tabContent'}">
								<li class="uk-active" aria-expanded="true">{{$singleproduct->heading2}}</li>
							</ul>
							<ul id="tabContent" class="uk-switcher tab-content">
								<li aria-hidden="false" class="uk-active">
									<article class="article detail-content">
						...
						<div class="prd-content" id='mat-bang'>
							<ul class="uk-list uk-clearfix nav-tabs" data-uk-switcher="{connect:'#tabContent'}">
								<li class="uk-active" aria-expanded="true">{{$singleproduct->heading3}}</li>
							</ul>
							<ul id="tabContent" class="uk-switcher tab-content">
								<li aria-hidden="false" class="uk-active">
									<article class="article detail-content">
						...
						<div class="prd-content" id='chinh-sach'>
							...
							<h3>{{$singleproduct->heading6}}</h3>
							<div class="chinh-sach-content">{!!$singleproduct->content6!!}</div>
							</div>
						</div><!-- .prd-content -->
						@endif
                    	@if($singleproduct->heading4)
						<div class="prd-content" id='noi-that'>
							<ul class="uk-list uk-clearfix nav-tabs" data-uk-switcher="{connect:'#tabContent'}">
								<li class="uk-active" aria-expanded="true">{{$singleproduct->heading4}}</li>
							</ul>
							<ul id="tabContent" class="uk-switcher tab-content">
								<li aria-hidden="false" class="uk-active">
									<article class="article detail-content">
						...
						<div class="prd-content" id='tien-do'>
							<ul class="uk-list uk-clearfix nav-tabs" data-uk-switcher="{connect:'#tabContent'}">
								<li class="uk-active" aria-expanded="true">{{$singleproduct->heading5}}</li>
							</ul>
							<ul id="tabContent" class="uk-switcher tab-content">
								<li aria-hidden="false" class="uk-active">
									<article class="article detail-content">
						...
						<div class="prd-content" id='dang-ky'>
							<ul class="uk-list uk-clearfix nav-tabs" data-uk-switcher="{connect:'#tabContent'}">
								<li style='text-align: center;float: inherit;' class="uk-active" aria-expanded="true">Đăng Ký Đặt Chỗ & Nhận Thông Tin Mở Bán và Ưu Đãi Mới Nhất</li>
							</ul>
							<ul id="tabContent" class="uk-switcher tab-content">
